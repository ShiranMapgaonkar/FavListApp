...
public class MainActivity extends AppCompatActivity implements CategoryFragment.OnCategoryInteractionListener {
    ...
    private FrameLayout categoryItemsFragmnentContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryItemsFragmnentContainer = findViewById(R.id.category_items_fragment_container);

        isTablet = categoryItemsFragmnentContainer != null;
    ...
    private void displayCreateCategoryItemDialog() {
        ...
        new AlertDialog.Builder(this)
                .setTitle("Enter an item name here")
